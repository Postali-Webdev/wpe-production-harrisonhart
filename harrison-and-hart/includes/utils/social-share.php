...
function social_share_settings()
{
    ...
    register_setting("social_share_config_section", "social-share-avvo");
...
{
    $html = "<div class='social-share-wrapper flex flex-nowrap items-center'>";
    ...
    {
        $html = $html . "<div class='facebook'><a target='_blank' href='https://www.facebook.com/sharer.php?u=" . $url . "'></a></div>";
    }
    ...
    {
        $html = $html . "<div class='linkedin'><a target='_blank' href='https://www.linkedin.com/shareArticle?url=" . $url . "'></a></div>";
    }

    if(get_option("social-share-google") == 1)
    {
        $html = $html . "<div class='google'><a target='_blank' href='https://plus.google.com/share?url=" . $url . "'></a></div>";
    }
